...
const News = (props)=>{
    ...
    const updateNews = async ()=> {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=29b6622824bf49479d119cab9f0f1124&page=${page}&pageSize=${props.pageSize}`; 
        setLoading(true)
